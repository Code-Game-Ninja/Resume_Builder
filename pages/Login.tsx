...
export const Login = () => {
  ...
  const { signIn, signUp, signInWithGoogle, signInWithGithub, isLoading, error, setError } = useStore();
      ...
      <Card className="w-full max-w-md relative z-10 border border-gray-800/50 backdrop-blur-xl bg-black/60">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">
            {isSignUp ? 'Sign up to start building resumes' : 'Sign in to manage your resumes'}
          </p>
        </div>
          ...
          {!isSignUp && (
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-gray-400 cursor-pointer">
                <input type="checkbox" className="rounded bg-gray-800 border-gray-700 text-primary-600 focus:ring-primary-600/50" />
                Remember me
              </label>
